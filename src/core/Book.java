     ...
     */
        ...
        public static String capitalize(String word) {
            ...
            if(word.length()>0){
                ...
                for (int i=0;i<name.length;i++){
                    name[i]=name[i].substring(0,1).toUpperCase().concat(name[i].substring(1).toLowerCase());
                namee+=name[i]+" ";
                }
            }else{
                return null;
        ...
        public void setTitle(String title) {
           ...
           title=title.trim();
            ...
            String newTitle = capitalize(titlee[0])+" ";
            for(int i=1;i<titlee.length;i++){
                if(isTitleWord(titlee[i])){
                    titlee[i]=capitalize(titlee[i]);
                    newTitle+=titlee[i]+" ";
                }else{
                    newTitle+=titlee[i].toLowerCase()+" ";
                }
            }
